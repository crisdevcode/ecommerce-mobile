  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          return PopularFoodDetail(pageId: int.parse(pageId!)); // print('Popular food get called');
        },
    ...
    GetPage(
        ...
        page: () {
          var pageId = Get.parameters['pageId'];
          return RecommendedFoodDetail(pageId: int.parse(pageId!) ); // print('Popular food get called');
        },
        transition: Transition.fadeIn)
  ];
}
