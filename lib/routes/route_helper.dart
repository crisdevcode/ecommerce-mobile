  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        ...
        page: () {
          ...
          return PopularFoodDetail(pageId: int.parse(pageId!), page: page!); // print('Popular food get called');
        },
    ...
    GetPage(
        ...
        page: () {
          var pageId = Get.parameters['pageId'];
          var page = Get.parameters['page'];
          return RecommendedFoodDetail(pageId: int.parse(pageId!), page: page!); // print('Popular food get called');
        },
        transition: Transition.fadeIn),
    GetPage(
        name: cartPage,
